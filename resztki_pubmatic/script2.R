...
namesPlacement <- c("Ad Tag Name","Site/App Identifier","Format Type","Response Code","Ad Size","Ad Placement","Fold Placement","Expansion Direction","User Data Parameters (Semicolon Separated List of key=value)","Ad Network ID","Ad Network Placement ID","Protocol (VAST 2.0/VAST 3.0)(Applicable in case of Video)","VPAID Support (Applicable in case of Video)","Time Range Min (Applicable in case of Video)","Time Range Max (Applicable in case of Video)","MIME Type (Semicolon Separated List)(Applicable in case of Video)","Default Player Size (WidthxHeight for static size/Dynamic or blank for dynamic size)(Applicable in case of Video)","Placement Type (Applicable in case of Video)","Linear Ad (Any/Linear/Non-Linear)(Applicable in case of Video and placement type is In-stream)","Positioning (Pre-roll/Mid-roll/Post-roll)(Applicable in case of Video and placement type is In-stream)","Playback Method (Semicolon Separated List)(Applicable in case of Video)","Skippable Ad (Y/N) (Applicable in case of Video)","Skippable after seconds (Applicable in case of Video and Skippable Ad is Y)","Max Bitrate (Applicable in case of Video)","Companion Ad (Y/N) (Applicable in case of Video)","Companion Adsize (Width x Height in case of Companion Ad is true)(Applicable in case of Video)","Video AdServer Name (Applicable in case of Video)","Video Player Name (Applicable in case of Video)")
#colnames(df) <- namesSite

createHTTP <- function(str){glue('https://{gsub("^m.","",tolower(str))}')}
createDomain <- function(str){glue('{gsub("^m.","",tolower(str))}')}
...
looperPlacement <- function(vector){
  df <- data.frame(matrix(ncol = 28, nrow = 0))  
  #namesSite <- c("Site ID (Should be blank for New Sites)","Site/App Domain","Site/App Identifier","Platform","Primary Vertical or Category","Secondary Vertical or Category(Semi-Colon Separated List; maximum 3 categories supported)","Monthly Ad Impressions","Privacy Policy URL","Is Default Site(Y/N)","API Setting Enabled(Y/N)","COPPA Compliant(Y/N)","Rich Media Compliance in case of App(Semi-Colon Separated List)","Override Publisher Data in case of App(Y/N)","Availablity on App Store(Y/N)","AppStore URL","Is Secure Site(Y/N)","Decision Manager Type(None/Premium/Standard)","Delete Site(Y/N)","Comments (Indicates Failure Reasons)")
