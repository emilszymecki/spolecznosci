...
var bids = Object.keys(pbsjs.getBidResponses()).reduce((agg,el) => {
    var split_name = el.split("_");
    var [head,tail] = split_name;
    var sspObj = pbsjs.getBidResponses()[el].bids[0]
    var {bidderCode,cpm} = sspObj
    agg[head] = {...agg[head],[bidderCode]:cpm}
    return agg
},{})
